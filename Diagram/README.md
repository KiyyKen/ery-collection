...
Folder ini berisi seluruh diagram UML (ERD, LRS, Use Case, Activity, Sequence, Class) untuk dokumentasi skripsi **"Implementasi Sistem Distribusi untuk Memprediksi Produk Terlaris dengan Algoritma C4.5 Berbasis Website pada Toko Yery Collection"**. Diagram ditulis sebagai kode (PlantUML), bukan gambar statis, supaya:
