# Ringkasan Teknis Project — Sistem Distribusi Ery Collection
...
- **Nama project**: Sistem Distribusi Ery Collection — judul skripsi: "Implementasi Sistem Distribusi untuk Memprediksi Produk Terlaris dengan Algoritma C4.5 Berbasis Website pada Toko Ery Collection".
...
- **Studi kasus penelitian**: Toko Ery Collection, usaha grosir celana anak, dengan data uji coba 20 produk dan 109 transaksi distribusi (periode Januari–Juni 2026, dibangkitkan lewat seeder, lihat Bagian 3 & 12).
